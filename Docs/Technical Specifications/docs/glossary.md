...
| ----------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DESCRIPTION | The Moderator-Client offers a graphical interface through which Moderator and PlayerAudience can interact with the game. The Moderator-Client establishes a connection to the server, which receives input from the PlayerAudience and visualises and logically implements the output of the server. A server connection is only needed to let the PlayerAudience participate in the game, but the moderator can also play the game alone. |
| IS-A        | Component                                                                                                                                                                                                                                                                                            |
| CAN-BE      | -                                                                                                                                                                                                                                                                                                    |
| EXAMPLE     | -                                                                                                                                                                                                                                                                                                    |
