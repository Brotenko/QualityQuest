...
public class ActiveScreenManagerTestClass
{
    ...
    public ActiveScreenManagerTestClass()
    {
        ...
        gameMenuPanel = GameObject.Instantiate(new GameObject());
        errorScreenPanel = GameObject.Instantiate(new GameObject());
        connectPanel = GameObject.Instantiate(new GameObject());
        qrCodePanel = GameObject.Instantiate(new GameObject());
        characterSelectionPanel = GameObject.Instantiate(new GameObject());
        decisionPanel = GameObject.Instantiate(new GameObject());
        storyFlowPanel = GameObject.Instantiate(new GameObject());
