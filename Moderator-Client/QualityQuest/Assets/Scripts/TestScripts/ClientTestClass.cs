...
public class ClientTestClass
{
    ...
    public ActiveScreenManagerTestClass activeScreenManager;
    public DisplayStatusbarTestClass displayStatusBar;
    public DisplayDecisionTestClass displayDecision;
    public DisplayStoryFlowTestClass displayStoryFlow;
    public ResultTestClass result;
    public DisplayStatistics displayStatistics;
    public CharacterSelectionTestClass characterSelection;
    public TMP_InputField ip;
    public TMP_InputField port;
    public TMP_InputField password;
    public TMP_InputField votingTime;
    public ClientLogic clientLogic;

    public ClientTestClass()
    {
        activeScreenManager = new ActiveScreenManagerTestClass();
        ...
        result = new ResultTestClass();
        displayStatistics = null;
        characterSelection = new CharacterSelectionTestClass();
        ip = new GameObject().AddComponent<TMP_InputField>();
        port = new GameObject().AddComponent<TMP_InputField>();
        password = new GameObject().AddComponent<TMP_InputField>();
        votingTime = new GameObject().AddComponent<TMP_InputField>();
    ...
    /// </summary>
    /// <param name="currentEvent">The current StoryEvent.</param>
    public void ContinueStoryDecision(StoryEvent currentEvent)
    {
        displayDecision.RemoveOnlineDecisionListeners();
    ...
    public void ContinueStoryFlow(StoryEvent currentEvent)
    {
        displayStoryFlow.RemoveStoryFlowListeners();
    ...
    public void ContinueBackground(StoryEvent currentEvent)
    {
    ...
    /// </summary>
    /// <param name="currentEvent"></param>
    public void ContinueOfflineDecision(StoryEvent currentEvent)
    {
        displayDecision.RemoveOfflineDecisionListeners();
