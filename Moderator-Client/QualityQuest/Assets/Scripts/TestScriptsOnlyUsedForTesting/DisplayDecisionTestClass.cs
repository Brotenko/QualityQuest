...
public class DisplayDecisionTestClass
{
    /// <summary>
    ...
    public DisplayDecisionTestClass()
    {

        selectOfflineA = new GameObject().AddComponent<Button>();
        selectOfflineB = new GameObject().AddComponent<Button>();
        selectOfflineC = new GameObject().AddComponent<Button>();
        selectOfflineD = new GameObject().AddComponent<Button>();

        selectOnlineA = new GameObject().AddComponent<Button>();
        selectOnlineB = new GameObject().AddComponent<Button>();
        selectOnlineC = new GameObject().AddComponent<Button>();
        selectOnlineD = new GameObject().AddComponent<Button>();

        titleA = new GameObject().AddComponent<TextMeshPro>();
        descriptionA = new GameObject().AddComponent<TextMeshPro>();
        panelA = new GameObject();

        titleB = new GameObject().AddComponent<TextMeshPro>();
        descriptionB = new GameObject().AddComponent<TextMeshPro>();
        panelB = new GameObject();

        titleC = new GameObject().AddComponent<TextMeshPro>();
        descriptionC = new GameObject().AddComponent<TextMeshPro>();
        panelC = new GameObject();

        titleD = new GameObject().AddComponent<TextMeshPro>();
        descriptionD = new GameObject().AddComponent<TextMeshPro>();
        panelD = new GameObject();

        question = new GameObject().AddComponent<TextMeshPro>();
