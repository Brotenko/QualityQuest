...
public class AudioMenuTestClass
{
    /// <summary>
    ...
    public AudioMenuTestClass()
    {

        mixer = Resources.Load<AudioMixer>("Sound");
        mixer = Resources.Load<AudioMixer>("Sound");
        masterSlider = Resources.Load<Slider>("SliderA");
        musicSlider = Resources.Load<Slider>("SliderB");
        effectsSlider = Resources.Load<Slider>("SliderC");
        ambientSlider = Resources.Load<Slider>("SliderD");

        masterVolume = new GameObject().AddComponent<TextMeshPro>();
        musicVolume = new GameObject().AddComponent<TextMeshPro>();
        effectsVolume = new GameObject().AddComponent<TextMeshPro>();
        ambientVolume = new GameObject().AddComponent<TextMeshPro>();
